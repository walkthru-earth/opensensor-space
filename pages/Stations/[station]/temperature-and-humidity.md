...
# {station_info[0].station_name} - Temperature & Humidity

<LastRefreshed/>

<Details title='About this dashboard'>

This dashboard analyzes temperature and humidity data from **{station_info[0].station_name}**. You can select a date range to view specific data.
...
- **Comfort Zones**: Ideal comfort zone is 18-25°C temperature and 30-60% humidity. Reference lines mark the boundaries.
- **Interpretation**:
