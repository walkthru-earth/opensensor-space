...
<Mermaid title="System Architecture" chart={systemArchitecture} />
...
<Mermaid title="Component Architecture" chart={componentArchitecture} />
...
<Mermaid title="Sensor to Cloud Pipeline" chart={sensorToCloudPipeline} />
...
<Mermaid title="Batch Processing Flow" chart={batchProcessingFlow} />
