...
<Grid cols=2>
    <div class="border rounded-lg p-4 my-2 mx-1 hover:shadow-md transition bg-green-50 dark:bg-green-900/30">
        <a href="/Stations/019ab390-f291-7a30-bca8-381286e4c2aa/temperature-and-humidity" class="flex items-center justify-between">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" height="1.5em" fill="currentColor" viewBox="0 0 320 512">
                <path d="M160 64c-26.5 0-48 21.5-48 48V276.5c0 17.3-7.1 31.9-15.3 42.5C86.2 332.6 80 349.5 80 368c0 44.2 35.8 80 80 80s80-35.8 80-80c0-18.5-6.2-35.4-16.7-48.9c-8.2-10.6-15.3-25.2-15.3-42.5V112c0-26.5-21.5-48-48-48zM48 112C48 50.1 98.1 0 160 0s112 50.1 112 112V276.5c0 2.8 1.1 5.5 2.2 7.6C291.1 306.5 304 335.3 304 368c0 79.5-64.5 144-144 144S16 447.5 16 368c0-32.7 12.9-61.5 29.8-83.9c1.1-2.2 2.2-4.9 2.2-7.6V112z"/>
            </svg>
        </a>
    </div>
    ...
    <div class="border rounded-lg p-4 my-2 mx-1 hover:shadow-md transition bg-slate-50 dark:bg-slate-900/30">
        <a href="/Stations/019ab390-f291-7a30-bca8-381286e4c2aa/health" class="flex items-center justify-between">
            <div>
